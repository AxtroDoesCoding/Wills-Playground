...
import net.axtro.willsplayground.item.custom.FuelItem;
import net.axtro.willsplayground.item.custom.MetalDetectorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BIO_FUEL = ITEMS.register("bio_fuel", () -> new FuelItem(new Item.Properties(), 400));
